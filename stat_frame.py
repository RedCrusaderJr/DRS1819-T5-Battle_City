...
class StatFrame(QFrame):
    ...
    def __init__(self, parent, game_board, font_size = 2):
        ...
        if self.game_board.mode is GameMode.MULTIPLAYER_OFFLINE or self.game_board.mode is GameMode.MULTIPLAYER_ONLINE_CLIENT:
    ...
    def changeLives(self, player, num_of_lives):
        ...
        elif player == 2 and (self.game_board.mode is GameMode.MULTIPLAYER_OFFLINE or self.game_board.mode is GameMode.MULTIPLAYER_ONLINE_CLIENT):
